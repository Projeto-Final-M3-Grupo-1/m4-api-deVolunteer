...
export class initialMigration1673892817478 implements MigrationInterface {
    name = 'initialMigration1673892817478'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users_to_projects" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid, "projectId" uuid, CONSTRAINT "PK_4dc526c94241f7b7f3949014a17" PRIMARY KEY ("id"))`);
