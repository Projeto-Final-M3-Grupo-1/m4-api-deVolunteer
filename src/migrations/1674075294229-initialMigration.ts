...
export class initialMigration1674075294229 implements MigrationInterface {
    name = 'initialMigration1674075294229'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tasks_to_projects" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_in" TIMESTAMP NOT NULL DEFAULT now(), "taskId" uuid, "projectId" uuid, CONSTRAINT "PK_c57b50f9f60e63b7f5942543226" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "tasks_to_projects" ADD CONSTRAINT "FK_203711c567383204179f4e2e58a" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tasks_to_projects" ADD CONSTRAINT "FK_ad75fe418464fa145b315689d56" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tasks_to_projects" DROP CONSTRAINT "FK_ad75fe418464fa145b315689d56"`);
        await queryRunner.query(`ALTER TABLE "tasks_to_projects" DROP CONSTRAINT "FK_203711c567383204179f4e2e58a"`);
        ...
        await queryRunner.query(`DROP TABLE "tasks_to_projects"`);
